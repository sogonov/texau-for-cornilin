...
\begin{landscape}
\imgh{250.5mm}{Figures/graph.png}{АЧХ, построенная по передаточной функции в программе Graph} 
% текст в альбомной ориентации
% (таблица, рисунок, схема и т. п.)
\end{landscape}

Расcчитанная схема была собрана в пакете Orcad (рисунок \ref{ris:Figures/orcad.png}), и там же была построена АЧХ фильтра(рисунок \ref{ris:Figures/orcad1.png}).


\imgh{140.5mm}{Figures/orcad1.png}{Схема фильтра, собранная в пакете Orcad}
\imghh{140.5mm}{Figures/orcad.png}{АЧХ, построенная в пакете Orcad} 
Таким образом, результаты расчета и симуляции схемы полностью совпадают.
\end{document}